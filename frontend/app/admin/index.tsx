...
import { BookArt, Badge, Button, Card, CardHead, CellText, Column, Empty, ErrorBanner, Grid, HeroCard, ListRow, Loading, PageHeading, Screen, Split, Stat, StatRow, Table, TextLink, RequestFailed } from "@/ui";
...
export default function AdminOverview() {
  ...
  return (
    <Screen refreshing={platform.loading} onRefresh={reload}>
      <PageHeading eyebrow="ADMINISTRATOR WORKSPACE" title="A clear view of your platform." subtitle="People, subjects, and teaching activity in one place."
        ...
        main={
          <>
            <HeroCard eyebrow="A HEALTHY LEARNING ENVIRONMENT" title="The right people. The right access." text="Keep accounts and subjects organized so teaching can happen without friction."
              action={<Button title="Add a person" icon="person-add-outline" onPress={() => router.push("/admin/user/new")} />} art={<BookArt title={"A place to teach.\nRoom to grow."} />} />
            <Card>
