...
export default function AttemptScreen() {
  ...
  if (!quiz) return <Screen><Notice inline title="Incomplete attempt link" message="Open this attempt from its quiz results to include the required quiz information." /></Screen>;
