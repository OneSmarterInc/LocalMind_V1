...
export default defineConfig({
 testDir:'.',testMatch:process.env.LM_E2E_BENCH==='1'?'private-performance.spec.ts':process.env.LM_E2E_REAL_MODEL==='1'?'private-real-model.spec.ts':[ 'private-browser.spec.ts','private-parser.spec.ts','private-quiz-stability.spec.ts' ],
