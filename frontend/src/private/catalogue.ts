...
/** Remove a shared book staff uploaded. Course books and already-downloaded copies are untouched. */
export function deleteSharedBook(id:string){return api<{id:string;deleted:boolean}>(`/faculty/private-library/${id}/`,{method:'DELETE'});}
