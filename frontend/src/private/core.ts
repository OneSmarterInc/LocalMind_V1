...
export type SourceVisual = { id: string; dataUrl: string; width: number; height: number; caption: string; kind?: 'page'|'figure'|'table'|'diagram'|'chart'; page?: number; contextText?: string; captionOrigin?: 'source'|'label'; headingPath?: string[]; assetId?: string };
