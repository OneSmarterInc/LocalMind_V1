  ...
  return (
    <View accessibilityRole={online ? undefined : "alert"} style={{ flexDirection: "row", flexWrap: "wrap", alignItems: "center", gap: 11, paddingHorizontal: 16, paddingVertical: 14, borderRadius: 9, backgroundColor: online ? "#F0F7F1" : "#FFFAEC", borderWidth: 1, borderColor: t.border, marginTop: 4 }}>
      ...
      <View style={{ flex: 1, minWidth: 180 }}>
        <Text style={{ color: t.fg, fontSize: 12, fontWeight: "600" }}>{online ? "Saving your course reading for offline use…" : "Offline · Continue with material saved on this device"}</Text>
        <Text style={{ color: t.fg, fontSize: 12, marginTop: 2, lineHeight: 18 }}>{online
          ? "Your open course modules and lessons are being saved. Private Library is stored separately on this device."
          : `${saved ? `Course copy: ${saved}. ` : "No complete course download yet. "}Private study and new doubts work with saved source, the installed model and offline app files. Official submissions still need the institution server.`}</Text>
      </View>
