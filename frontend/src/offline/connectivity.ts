...
// outcome; while offline a bounded ping backs off from roughly 5 seconds and, the moment
...
export function configurePing(url: string) { recovery.stop();pingUrl = url;if(!online)recovery.start(); }
