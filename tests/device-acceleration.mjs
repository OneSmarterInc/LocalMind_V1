...
const built=await build({entryPoints:[fileURLToPath(new URL('../frontend/src/private/acceleration.ts',import.meta.url))],bundle:true,platform:'node',format:'cjs',write:false});
