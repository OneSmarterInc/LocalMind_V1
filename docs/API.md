...
| `/api/faculty/` | faculty and admin | assigned subjects, students, documents and outlines, module availability, quizzes, subject analytics |
| `/api/student/` | student | enrolled subjects, published content, quizzes, tutor, time reporting, own analytics |
